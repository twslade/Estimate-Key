...
jQuery.Velocity ? console.log("Velocity is already loaded. You may be needlessly importing Velocity again; note that Materialize includes Velocity.") : (!function(e) {
    ...
    if (!e.jQuery) {
        ...
        r.isWindow = function(e) {
            ...
            l === u && (s = this, l--); u > l; l++) if (null != (o = arguments[l])) for (n in o) e = s[n], 
            a = o[n], s !== a && (c && a && (r.isPlainObject(a) || (t = r.isArray(a))) ? (t ? (t = !1, 
            i = e && r.isArray(e) ? e : []) : i = e && r.isPlainObject(e) ? e : {}, s[n] = r.extend(c, i, a)) : void 0 !== a && (s[n] = a));
            return s;
    ...
    return function(e, t, r, a) {
        ...
        function u(e, t) {
            ...
            r === !1 && (r = b.Easings[b.defaults.easing] ? b.defaults.easing : v), r;
        }
        function c(e) {
            if (e) {
        ...
        var x = function() {
            ...
            return function a(e, t, n) {
                ...
                l.friction = t, o = null !== n, o ? (c = a(e, t), i = c / n * f) : i = f; s = r(s || l, i), 
        ...
        var S = b.CSS = {
            ...
            Hooks: {
                ...
                injectValue: function(e, t, r) {
                    ...
                    if (a) {
                        var n, o, i = a[0], s = a[1];
                        return r = S.Hooks.cleanRootPropertyValue(i, r), n = r.toString().match(S.RegEx.valueSplit), 
                        n[s] = t, o = n.join(" ");
                    }
                    return r;
                }
            ...
            Names: {
                ...
                prefixCheck: function(e) {
                    ...
                    for (var t = [ "", "Webkit", "Moz", "ms", "O" ], r = 0, a = t.length; a > r; r++) {
                        ...
                        }), m.isString(b.State.prefixElement.style[n])) return b.State.prefixMatches[e] = n, 
                        [ n, !0 ];
                    }
                    return [ e, !1 ];
                }
            ...
            getPropertyValue: function(e, r, n, o) {
                function s(e, r) {
                    ...
                    if (8 >= d) l = f.css(e, r); else {
                        ...
                        "borderColor" === r && (r = "borderTopColor"), l = 9 === d && "filter" === r ? g.getPropertyValue(r) : g[r], 
                ...
                if (S.Hooks.registered[r]) {
                    ...
                    var p, g;
                    p = S.Normalizations.registered[r]("name", e), "transform" !== p && (g = s(e, S.Names.prefixCheck(p)[0]), 
                ...
                return S.Values.isCSSNullValue(l) && (l = 0), b.debug >= 2 && console.log("Get " + r + ": " + l), 
                l;
            },
            setPropertyValue: function(e, r, a, n, o) {
                ...
                s = "transform", a = i(e).transformCache[r]; else {
                    ...
                    r = S.Normalizations.registered[r]("name", e)), s = S.Names.prefixCheck(r)[0], 8 >= d) try {
                        e.style[s] = a;
                    } catch (c) {
        ...
        var P = function() {
            ...
            function n() {
                function e(e) {
                    ...
                    function h() {
                        ...
                        l.remToPx = L.remToPx, l.vwToPx = L.vwToPx, l.vhToPx = L.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), o), 
                        l;
                    }
                    if (s.begin && 0 === V) try {
                        s.begin.call(g, g);
                    ...
                    if ("scroll" === A) {
                        ...
                        P = s.container["scroll" + F], T = P + f(o).position()[F.toLowerCase()] + j) : s.container = null : (P = b.State.scrollAnchor[b.State["scrollProperty" + F]], 
                ...
                s.mobileHA = s.mobileHA && b.State.isMobile && !b.State.isGingerbread, s.queue === !1 ? s.delay ? setTimeout(e, s.delay) : e() : f.queue(o, s.queue, function(t, r) {
                    return r === !0 ? (k.promise && k.resolver(g), !0) : (b.velocityQueueEntryFlag = !0, 
                    void e(t));
            ...
            if (m.isWrapped(this) ? (s = !1, d = 0, g = this, l = this) : (s = !0, d = 1, g = x ? arguments[0].elements || arguments[0].e : arguments[0]), 
            g = o(g)) {
                x ? (y = arguments[0].properties || arguments[0].p, v = arguments[0].options || arguments[0].o) : (y = arguments[d], 
                v = arguments[d + 1]);
                var w = g.length, V = 0;
...
!function(a, b, c, d) {
    ...
    Yb.prototype = {
        ...
        recognize: function(a) {
            ...
            this.state = this.process(b), this.state & (Sb | Tb | Ub | Wb) && this.tryEmit(b), 
            void 0) : (this.reset(), this.state = Xb, void 0);
        },
        process: function() {},
...
(function(window) {
    var lastTime = 0, vendors = [ "webkit", "moz" ], requestAnimationFrame = window.requestAnimationFrame, cancelAnimationFrame = window.cancelAnimationFrame, i = vendors.length;
        ...
        init: function(options) {
            ...
            return this.each(function() {
                ...
                var openModal = function($trigger) {
                    ...
                    lStack = ++_stack;
                    $overlay.attr("id", overlayID).css("z-index", 1e3 + lStack * 2);
                    $modal.data("overlay-id", overlayID).css("z-index", 1e3 + lStack * 2 + 1);
                    $modal.addClass("open");
                    $("body").append($overlay);
        ...
        return this.each(function() {
            ...
            origin.on("click", function() {
                ...
                if (widthPercent > heightPercent) {
                    ...
                    newHeight = windowWidth * .9 * ratio;
                } else {
                    ratio = originalWidth / originalHeight;
                    newWidth = windowHeight * .9 * ratio;
    ...
    var methods = {
        init: function(options) {
            ...
            return this.each(function(i) {
                ...
                var $active, $content, $links = $this.find("li.tab a"), $tabs_width = $this.width(), $tabs_content = $(), $tabs_wrapper, $tab_width = Math.max($tabs_width, $this[0].scrollWidth) / $links.length, $indicator, index = prev_index = 0, clicked = false, clickedTimeout, transition = 300;
                ...
                if (options.draggable) {
                    ...
                    $dragTarget.hammer({
                        ...
                        if (e.gesture.pointerType == "touch") {
                            ...
                            panning = false;
                            if (options.edge === "left") {
                                if (menuOut && velocityX <= .3 || velocityX < -.5) {
                                    if (leftPos !== 0) {
                                        menu.velocity({
            ...
            return this.each(function() {
                ...
                $this.hammer({
                    ...
                    if (e.gesture.pointerType === "touch") {
                        ...
                        if (direction === 4 && (x > $this.innerWidth() / 2 || velocityX < -.65)) {
                            swipeRight = true;
                        } else if (direction === 2 && (x < -1 * $this.innerWidth() / 2 || velocityX > .65)) {
                            swipeLeft = true;
                        }
                        var next_slide;
                        if (swipeLeft) {
        ...
        $(".dismissable").each(function() {
            $(this).hammer({
                ...
                if (e.gesture.pointerType === "touch") {
                    ...
                    if (direction === 4 && (x > $this.innerWidth() / 2 || velocityX < -.75)) {
                        swipeLeft = true;
                    }
                    if (direction === 2 && (x < -1 * $this.innerWidth() / 2 || velocityX > .75)) {
                        swipeRight = true;
                    }
                }
            }).bind("panend", function(e) {
        ...
        init: function(options) {
            ...
            return this.each(function(i) {
                ...
                if (view.hasClass("initialized")) {
                    ...
                    $(this).trigger("carouselNext", [ 1e-6 ]);
                    return true;
                }
                ...
                function scroll(x) {
                    ...
                    for (i = 1; i <= half; ++i) {
                        if (options.fullWidth) {
                            ...
                            tweenedOpacity = 1 - .2 * (i * 2 + tween * dir);
                        }
        ...
        init: function(options) {
            return this.each(function() {
                ...
                var calculateTapTarget = function() {
                    ...
                    var isCenterY = originTop >= windowHeight * .25 && originTop <= windowHeight * .75;
